...
class ForumTopicsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'forum_topics_ibfk_1' => ['type' => 'foreign', 'columns' => ['forum_id'], 'references' => ['forums', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'forum_topics_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 'b829f558-a267-435f-9043-9c8927afd06e',
            'forum_id' => '4741e209-8f74-4da8-87a9-930bcc2d0208',
            'user_id' => 'bf505eba-437b-43cd-95bd-3f865a83d510',
